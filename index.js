...
switch (platform) {
    ...
    switch (arch) {
      case "arm64":
        localFileExisted = existsSync(
          join(__dirname, "cel-typescript.android-arm64.node"),
        );
        try {
          if (localFileExisted) {
      ...
      case "arm":
        localFileExisted = existsSync(
          join(__dirname, "cel-typescript.android-arm-eabi.node"),
        );
        try {
          if (localFileExisted) {
  ...
  case "darwin":
    localFileExisted = existsSync(
      join(__dirname, "cel-typescript.darwin-universal.node"),
    );
    try {
      if (localFileExisted) {
    ...
    switch (arch) {
      case "x64":
        localFileExisted = existsSync(
          join(__dirname, "cel-typescript.darwin-x64.node"),
        );
        try {
          if (localFileExisted) {
  ...
  case "freebsd":
    ...
    localFileExisted = existsSync(
      join(__dirname, "cel-typescript.freebsd-x64.node"),
    );
    try {
      if (localFileExisted) {
...
const { CelProgram } = nativeBinding;

module.exports.CelProgram = CelProgram;
